...
SceneController.prototype.setupGUI = function()
{
    ...
    this.gui.add(this.params, 'shader', [ 'simple', 'dynamic', 'flat', 'Gouraud', 'Phong', 'Blinn-Phong', 'toon', 'heatmap'] ).name('Shader').onChange(function(newValue){this.object.screenController.changeShader()});
