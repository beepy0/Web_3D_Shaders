...
SceneController.prototype.setupGUI = function()
{
    ...
    this.gui.add(this.params, 'shader', [ 'simple', 'dynamic', 'flat', 'Gouraud', 'Phong', 'Blinn-Phong', 'toon', 'Gooch'] ).name('Shader').onChange(function(newValue){this.object.screenController.changeShader()});
